...
<head>
    ...
    <link href="{{ asset('css/new_view.css') }}" rel="stylesheet">
    ...
    @include('partials.sticky_relocate')
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbar">
                <ul class="nav navbar-nav">
                    <li>
                        {{ link_to_route('top', Lang::get('common.header.top'), array(), array('class' => '', 'id' => 'top')) }}
                    </li>
                    <li>
                        {{ link_to_route('vote', Lang::get('common.header.vote'), array(), array('class' => '', 'id' => 'vote')) }}
                    </li>
                    <li>
            ...
            <ul class="nav pull-right navbar-nav">
                ...
                @else
                  ...
                  <li class="dropdown">
                    ...
                    <a href='{{ URL::route("messages") }}' style="padding-top: 0px;padding-bottom: 0px; line-height: 0px; position: initial;;
">
                      <span id="notification" class="message-notification" style=""> {{Auth::user()->unreadMessages->count()}} <span class="glyphicon glyphicon-envelope"></span></span>
                    </a>
                    @endif
                    <ul class="dropdown-menu">
                        ...
                        <li>
                            <a href="#"><i class="fa fa-fw fa-gear"></i>{{ link_to_route('messages', Lang::get("common.messages")) }}</a>
                        </li>
                        <li class="divider"></li>
                        <li>
    ...
    <div class="container">
        <div id='wrap'>
            @include('partials.feedback_image')
            @if (false)
                @include('partials.well_come_modal')
            @endif
            @yield('content')
        </div>
    </div>
        ...
        <div id="footer">
          <div class="foot-wrap">
              <div class="foot-header">
                <div class="foot-letf">Fun4v – Giải trí tổng hợp, ảnh gái xinh, tin tức hot, clip hài&nbsp; ©&nbsp;2015</div>
                <div class="foot-right">Copyright @ 2015 by <a href="http://fun4v.com">fun4v.com</a></div>
              </div> 
