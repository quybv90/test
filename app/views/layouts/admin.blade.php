    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <ul class="nav navbar-right top-nav">
                <li>{{ link_to_action('index', "User's pages", array(), array('class' => 'navbar-brand')) }}</li>
                <li class="dropdown">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    ...
                    <li>
                     ...
                     <li>
                       <i class="fa fa-fw fa-bar-chart-o"></i>{{ HTML::link('admin/events', 'Events') }}
                    </li>
                    <li>
                       <i class="fa fa-fw fa-bar-chart-o"></i>{{ HTML::link('admin/messages', 'Messages') }}
                    </li>
                    <li>
